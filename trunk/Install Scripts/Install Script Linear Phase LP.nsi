...
;General
  ...
  ;Name and file
  Name "Linear Phase LP Installer"
  OutFile "Linear_Phase_LP_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Linear Phase LP"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Linear Phase LP.dll"
  ${Else}
  File "..\Bin\Win32\VST\Linear Phase LP.dll"
  ...
  StrCpy $0 "$INSTDIR\Linear Phase LP.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Linear_Phase_LP.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Linear Phase LP VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Linear Phase LP VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Linear Phase LP.pdf"

...
;Simple Feedback Compressor Installer
...
;General
  ...
  ;Name and file
  Name "Simple Feedback Compressor Installer"
  OutFile "Simple_Feedback_Compressor_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Simple Feedback Compressor"
...
Section "Simple Feedback Compressor VST-Plugin" SecVstPlugin
  SetOutPath "$INSTDIR"
  
  !system 'copy "..\Bin\SimpleFeedbackCompressor.dll" "..\Bin\Simple Feedback Compressor.dll"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Simple Feedback Compressor.dll"
  ...
  StrCpy $0 "$INSTDIR\Simple Feedback Compressor.dll" 
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Simple Feedback Compressor VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Simple Feedback Compressor VST Plugin"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Simple Feedback Compressor.dll"

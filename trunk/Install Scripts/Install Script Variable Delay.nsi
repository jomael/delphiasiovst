...
;General
  ...
  ;Name and file
  Name "Variable Delay Installer"
  OutFile "Variable_Delay_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Variable Delay"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Variable Delay.dll"
  ${Else}
  File "..\Bin\Win32\VST\Variable Delay.dll"
  ...
  StrCpy $0 "$INSTDIR\Variable Delay.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Variable_Delay.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Variable Delay VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Variable Delay VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Variable Delay.pdf"

...
Section "SoundTouch Pitch Shifter VST-Plugin" SecVstPlugin
  SetOutPath "$INSTDIR"
  ...
  StrCpy $0 "$INSTDIR\SoundTouch Pitch Shifter.dll" 
...
;Descriptions
  ...
  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "SoundTouch Pitch Shifter VST Plugin"

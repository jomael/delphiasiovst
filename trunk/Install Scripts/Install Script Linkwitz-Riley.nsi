...
;General
  ...
  ;Name and file
  Name "Linkwitz-Riley Installer"
  OutFile "Linkwitz-Riley_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Linkwitz-Riley"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Linkwitz-Riley.dll"
  ${Else}
  File "..\Bin\Win32\VST\Linkwitz-Riley.dll"
  ...
  StrCpy $0 "$INSTDIR\Linkwitz-Riley.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Linkwitz-Riley.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Linkwitz-Riley VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Linkwitz-Riley VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Linkwitz-Riley.dll"
  Delete "$INSTDIR\Linkwitz-Riley.pdf"

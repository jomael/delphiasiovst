...
;Sidechain Compressor Installer
...
;General
  ...
  ;Name and file
  Name "Sidechain Compressor Installer"
  OutFile "Sidechain_Compressor_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Sidechain Compressor"
...
Section "Sidechain Compressor VST-Plugin" SecVSTPlugin
  SetOutPath "$INSTDIR"
  
  !system 'copy "..\Bin\SidechainCompressor.dll" "..\Bin\Sidechain Compressor.dll"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Sidechain Compressor.dll"
  ...
  StrCpy $0 "$INSTDIR\Sidechain Compressor.dll" 
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Sidechain_Compressor.exe"
SectionEnd

Section "Sidechain Compressor Manual" SecManual
  SetOutPath "$INSTDIR"
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Sidechain Compressor VST Plugin"

  LangString DESC_SecVSTPlugin ${LANG_ENGLISH} "Sidechain Compressor VST Plugin"
  LangString DESC_SecManual ${LANG_ENGLISH} "Sidechain Compressor Manual"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Sidechain Compressor.dll"
  Delete "$INSTDIR\Sidechain Compressor Manual.pdf"

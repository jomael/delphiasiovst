...
;General
  ...
  ;Name and file
  Name "Chebyshev Type2 LP Installer"
  OutFile "Chebyshev_Type2_LP_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Chebyshev Type2 LP"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Chebyshev Type2 LP.dll"
  ${Else}
  File "..\Bin\Win32\VST\Chebyshev Type2 LP.dll"
  ...
  StrCpy $0 "$INSTDIR\Chebyshev Type2 LP.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Chebyshev_Type2_LP.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Chebyshev Type2 LP VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Chebyshev Type2 LP VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Chebyshev Type2 LP.dll"
  Delete "$INSTDIR\Chebyshev Type2 LP.pdf"

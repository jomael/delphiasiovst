...
;General
  ...
  OutFile "Party-Delay_Install.exe"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Party-Delay.dll"
  ${Else}
  File "..\Bin\Win32\VST\Party-Delay.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Party-Delay.exe"
SectionEnd
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Party-Delay.pdf"

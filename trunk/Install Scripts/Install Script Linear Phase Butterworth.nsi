...
;General
  ...
  ;Name and file
  Name "Linear Phase Butterworth Installer"
  OutFile "Linear_Phase_Butterworth_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Linear Phase Butterworth"
...
Section "VST-Plugin" SecVstPlugin
  ...
  !system 'copy "..\Bin\LinearPhaseButterworthLP.dll" "..\Bin\Linear Phase Butterworth LP.dll"'  
  !system 'copy "..\Bin\LinearPhaseButterworthHP.dll" "..\Bin\Linear Phase Butterworth HP.dll"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Linear Phase Butterworth LP.dll"
  File "..\Bin\Linear Phase Butterworth HP.dll"
  ...
  StrCpy $0 "$INSTDIR\Linear Phase Butterworth LP.dll" 
  System::Call 'madExcept Patch::PatchMadExceptDLL(t) i (r0).r1'
  StrCpy $0 "$INSTDIR\Linear Phase Butterworth HP.dll" 
  System::Call 'madExcept Patch::PatchMadExceptDLL(t) i (r0).r1'
  System::Free 0
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Linear_Phase_Butterworth.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Linear Phase Butterworth VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Linear Phase Butterworth VST Plugin"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Linear Phase Butterworth LP.dll"
  Delete "$INSTDIR\Linear Phase Butterworth HP.dll"

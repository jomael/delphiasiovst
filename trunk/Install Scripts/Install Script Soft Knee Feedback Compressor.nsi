...
;Soft Knee Feedback Compressor Installer
...
;General
  ...
  ;Name and file
  Name "Soft Knee Feedback Compressor Installer"
  OutFile "Soft_Knee_Feedback_Compressor_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Soft Knee Feedback Compressor"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Soft Knee Feedback Compressor.dll"
  ${Else}
  File "..\Bin\Win32\VST\Soft Knee Feedback Compressor.dll"
  ...
  StrCpy $0 "$INSTDIR\Soft Knee Feedback Compressor.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Soft_Knee_Feedback_Compressor.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Soft Knee Feedback Compressor VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Soft Knee Feedback Compressor VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Soft Knee Feedback Compressor.dll"
  Delete "$INSTDIR\Soft Knee Feedback Compressor.pdf"

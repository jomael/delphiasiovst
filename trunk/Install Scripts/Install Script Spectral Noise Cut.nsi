...
;General
  ...
  ;Name and file
  Name "Spectral Noise Cut Installer"
  OutFile "Spectral_Noise_Cut_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Spectral Noise Cut"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Spectral Noise Cut.dll"
  ${Else}
  File "..\Bin\Win32\VST\Spectral Noise Cut.dll"
  ...
  StrCpy $0 "$INSTDIR\Spectral Noise Cut.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Spectral_Noise_Cut.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Spectral Noise Cut VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Spectral Noise Cut VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Spectral Noise Cut.dll"
  Delete "$INSTDIR\Spectral Noise Cut.pdf"

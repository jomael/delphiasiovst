...
;General
  ...
  ;Name and file
  Name "Linear Phase FFT Installer"
  OutFile "Linear_Phase_FFT_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Linear Phase FFT"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Linear Phase FFT.dll"
  ${Else}
  File "..\Bin\Win32\VST\Linear Phase FFT.dll"
  ...
  StrCpy $0 "$INSTDIR\Linear Phase FFT.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Linear_Phase_FFT.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Linear Phase FFT VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Linear Phase FFT VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Linear Phase FFT.dll"
  Delete "$INSTDIR\Linear Phase FFT.pdf"

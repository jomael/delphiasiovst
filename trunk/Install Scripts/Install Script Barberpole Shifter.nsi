...
;General
  ...
  ;Name and file
  Name "Barberpole Shifter Installer"
  OutFile "Barberpole_Shifter_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Barberpole Shifter"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Barberpole Shifter.dll"
  ${Else}
  File "..\Bin\Win32\VST\Barberpole Shifter.dll"
  ...
  StrCpy $0 "$INSTDIR\Barberpole Shifter.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Barberpole_Shifter.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Barberpole Shifter VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Barberpole Shifter VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Barberpole Shifter.dll"
  Delete "$INSTDIR\Barberpole Shifter.pdf"

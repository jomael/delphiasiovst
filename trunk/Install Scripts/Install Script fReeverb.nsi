...
;General
  ...
  ;Name and file
  Name "fReeverb Installer"
  OutFile "fReeverb_Install.exe"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_fReeverb.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "fReeverb VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "fReeverb VST Plugin"

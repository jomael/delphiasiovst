...
;Linear Phase LinkwitzRiley HP Installer
...
;General
  ...
  ;Name and file
  Name "Linear Phase LinkwitzRiley HP Installer"
  OutFile "Linear_Phase_LinkwitzRiley_HP_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Linear Phase LinkwitzRiley HP"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Linear Phase LinkwitzRiley HP.dll"
  ${Else}
  File "..\Bin\Win32\VST\Linear Phase LinkwitzRiley HP.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Linear_Phase_LinkwitzRiley_HP.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Linear Phase LinkwitzRiley HP VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Linear Phase LinkwitzRiley HP VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Linear Phase LinkwitzRiley HP.pdf"

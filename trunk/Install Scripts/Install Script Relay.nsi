...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Relay.dll"
  ${Else}
  File "..\Bin\Win32\VST\Relay.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Relay.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Relay VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Relay VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Relay.dll"
  Delete "$INSTDIR\Relay.pdf"

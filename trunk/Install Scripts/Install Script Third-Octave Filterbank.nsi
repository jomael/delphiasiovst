...
;Third-Octave Filterbank Installer
...
;General
  ...
  ;Name and file
  Name "Third-Octave Filterbank Installer"
  OutFile "Third-Octave_Filterbank_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Third-Octave Filterbank"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Third-Octave Filterbank.dll"
  ${Else}
  File "..\Bin\Win32\VST\Third-Octave Filterbank.dll"
  ...
  StrCpy $0 "$INSTDIR\Third-Octave Filterbank.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Third-Octave_Filterbank.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Third-Octave Filterbank VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Third-Octave Filterbank VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Third-Octave Filterbank.dll"
  Delete "$INSTDIR\Third-Octave Filterbank.pdf"

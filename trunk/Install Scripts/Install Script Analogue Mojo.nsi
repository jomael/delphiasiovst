...
;General
  ...
  ;Name and file
  Name "Analogue Mojo Installer"
  OutFile "Analogue_Mojo_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Analogue Mojo"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Analogue Mojo.dll"
  ${Else}
  File "..\Bin\Win32\VST\Analogue Mojo.dll"
  ...
  StrCpy $0 "$INSTDIR\Analogue Mojo.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Analogue_Mojo.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Analogue Mojo VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Analogue Mojo VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Analogue Mojo.dll"
  Delete "$INSTDIR\Analogue Mojo.pdf"

...
;General
  ...
  ;Name and file
  Name "Lookahead Limiter Installer"
  OutFile "Lookahead_Limiter_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Lookahead Limiter"
...
Section "Lookahead Limiter VST-Plugin" SecVSTPlugin
  SetOutPath "$INSTDIR"
...
Section "Lookahead Limiter Manual" SecManual
  SetOutPath "$INSTDIR"
  
  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Lookahead Limiter.pdf"

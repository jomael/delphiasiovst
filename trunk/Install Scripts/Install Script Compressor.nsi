...
;General
  ...
  ;Name and file
  Name "Compressor Installer"
  OutFile "Compressor_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Compressor"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Compressor.dll"
  ${Else}
  File "..\Bin\Win32\VST\Compressor.dll"
  ...
  StrCpy $0 "$INSTDIR\Compressor.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Compressor.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Compressor VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Compressor VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Compressor.dll"
  Delete "$INSTDIR\Compressor.pdf"

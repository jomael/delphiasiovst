...
;General
  ...
  ;Name and file
  Name "Noise Reduction Installer"
  OutFile "Noise_Reduction_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Noise Reduction"
...
Section "Noise Reduction VST-Plugin" SecVSTPlugin
  SetOutPath "$INSTDIR"
  
  !system 'copy "..\Bin\NoiseReduction.dll" "..\Bin\Noise Reduction.dll"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Noise Reduction.dll"
  ...
  StrCpy $0 "$INSTDIR\Noise Reduction.dll" 
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Noise_Reduction.exe"
SectionEnd

Section "Noise Reduction Manual" SecManual
  SetOutPath "$INSTDIR"
  
  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Noise Reduction.pdf"
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Noise Reduction VST Plugin"

  LangString DESC_SecVSTPlugin ${LANG_ENGLISH} "Noise Reduction VST Plugin"
  LangString DESC_SecManual ${LANG_ENGLISH} "Noise Reduction Manual"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Noise Reduction.dll"
  Delete "$INSTDIR\Noise Reduction.pdf"

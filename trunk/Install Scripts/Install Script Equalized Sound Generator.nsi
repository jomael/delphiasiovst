...
;Equalized Sound Generator Installer
...
;General
  ...
  ;Name and file
  Name "Equalized Sound Generator Installer"
  OutFile "Equalized_Sound_Generator_Install.exe"

  ;Default installation folder
  InstallDir "$PROGRAMFILES\Equalized Sound Generator"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Equalized Sound Generator"
...
Section "Program Files" SecProgramFiles
  ...
  !system 'copy "..\Bin\EqualizedSoundGenerator.exe" "..\Bin\Equalized Sound Generator.exe"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Equalized Sound Generator.exe"

  ;Store installation folder
  WriteRegStr HKLM "SOFTWARE\Delphi ASIO & VST Packages\${PRODUCT_NAME}" "" $INSTDIR
  
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Equalized_Sound_Generator.exe"
SectionEnd
...
Section "Manual" SecManual
  ...
  ;ADD YOUR OWN FILES HERE...
  File "..\Manuals\Equalized Sound Generator.pdf"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Equalized Sound Generator.exe"
  Delete "$INSTDIR\Equalized Sound Generator.pdf"

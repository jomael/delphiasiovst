...
;General
  ...
  ;Name and file
  Name "HeadphoneMix Installer"
  OutFile "HeadphoneMix_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "HeadphoneMix"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\HeadphoneMix.dll"
  ${Else}
  File "..\Bin\Win32\VST\HeadphoneMix.dll"
  ...
  StrCpy $0 "$INSTDIR\HeadphoneMix.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_HeadphoneMix.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "HeadphoneMix VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "HeadphoneMix VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\HeadphoneMix.dll"
  Delete "$INSTDIR\HeadphoneMix.pdf"

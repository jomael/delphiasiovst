...
;General
  ...
  ;Name and file
  Name "Tanh Waveshaper Installer"
  OutFile "Tanh_Waveshaper_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Tanh Waveshaper"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Tanh Waveshaper.dll"
  ${Else}
  File "..\Bin\Win32\VST\Tanh Waveshaper.dll"
  ...
  StrCpy $0 "$INSTDIR\Tanh Waveshaper.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Tanh_Waveshaper.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Tanh Waveshaper VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Tanh Waveshaper VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Tanh Waveshaper.dll"
  Delete "$INSTDIR\Tanh Waveshaper.pdf"

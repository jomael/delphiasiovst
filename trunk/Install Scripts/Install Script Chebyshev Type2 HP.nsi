...
;General
  ...
  ;Name and file
  Name "Chebyshev Type2 HP Installer"
  OutFile "Chebyshev_Type2_HP_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Chebyshev Type2 HP"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Chebyshev Type2 HP.dll"
  ${Else}
  File "..\Bin\Win32\VST\Chebyshev Type2 HP.dll"
  ...
  StrCpy $0 "$INSTDIR\Chebyshev Type2 HP.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Chebyshev_Type2_HP.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Chebyshev Type2 HP VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Chebyshev Type2 HP VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Chebyshev Type2 HP.dll"
  Delete "$INSTDIR\Chebyshev Type2 HP.pdf"

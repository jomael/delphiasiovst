...
;Lightweight Feedback Limiter Installer
...
;General
  ...
  ;Name and file
  Name "Lightweight Feedback Limiter Installer"
  OutFile "Lightweight_Feedback_Limiter_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Lightweight Feedback Limiter"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Lightweight Feedback Limiter.dll"
  ${Else}
  File "..\Bin\Win32\VST\Lightweight Feedback Limiter.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Lightweight_Feedback_Limiter.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Lightweight Feedback Limiter VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Lightweight Feedback Limiter VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Lightweight Feedback Limiter.pdf"

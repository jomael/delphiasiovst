...
;General
  ...
  ;Name and file
  Name "Parametric EQ Installer"
  OutFile "Parametric_EQ_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Parametric EQ"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Parametric EQ.dll"
  ${Else}
  File "..\Bin\Win32\VST\Parametric EQ.dll"
  ...
  StrCpy $0 "$INSTDIR\Parametric EQ.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Parametric_EQ.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Parametric EQ VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Parametric EQ VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Parametric EQ.dll"
  Delete "$INSTDIR\Parametric EQ.pdf"

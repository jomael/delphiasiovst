...
;General
  ...
  ;Name and file
  Name "Moog LP Installer"
  OutFile "Moog_LP_Install.exe"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Moog LP.dll"
  ${Else}
  File "..\Bin\Win32\VST\Moog LP.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Moog_LP.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Moog LP VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Moog LP VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Moog LP.dll"
  Delete "$INSTDIR\Moog LP.pdf"

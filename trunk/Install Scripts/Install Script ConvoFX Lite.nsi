...
;General
  ...
  ;Name and file
  Name "ConvoFX Lite Installer"
  OutFile "ConvoFX_Lite_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "ConvoFX Lite"
...
Section "ConvoFX Lite VST-Plugin" SecVSTPlugin
  SetOutPath "$INSTDIR"
  
  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\ConvoFXLite.dll"
  ...
  StrCpy $0 "$INSTDIR\ConvoFXLite.dll" 
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_ConvoFX_Lite.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "ConvoFX Lite VST Plugin"

  LangString DESC_SecVSTPlugin ${LANG_ENGLISH} "ConvoFX Lite VST Plugin"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\ConvoFXLite.dll"

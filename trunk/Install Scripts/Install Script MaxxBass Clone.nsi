...
;General
  ...
  ;Name and file
  Name "MaxxBass Clone Installer"
  OutFile "MaxxBass_Clone_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "MaxxBass Clone"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\MaxxBass Clone.dll"
  ${Else}
  File "..\Bin\Win32\VST\MaxxBass Clone.dll"
  ...
  StrCpy $0 "$INSTDIR\MaxxBass Clone.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_MaxxBass_Clone.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "MaxxBass Clone VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "MaxxBass Clone VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\MaxxBass Clone.dll"
  Delete "$INSTDIR\MaxxBass Clone.pdf"

...
;General
  ...
  ;Name and file
  Name "Limiter Installer"
  OutFile "Limiter_Install.exe"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Limiter.dll"
  ${Else}
  File "..\Bin\Win32\VST\Limiter.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Limiter.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Limiter VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Limiter VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Limiter.dll"
  Delete "$INSTDIR\Limiter.pdf"

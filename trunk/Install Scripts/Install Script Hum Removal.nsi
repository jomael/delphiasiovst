...
;General
  ...
  ;Name and file
  Name "Hum Removal Installer"
  OutFile "Hum_Removal_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Hum Removal"
...
Section "Hum Removal VST-Plugin" SecVSTPlugin
  SetOutPath "$INSTDIR"
  
  !system 'copy "..\Bin\HumRemoval.dll" "..\Bin\Hum Removal.dll"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Hum Removal.dll"
  ...
  StrCpy $0 "$INSTDIR\Hum Removal.dll" 
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Hum_Removal.exe"
SectionEnd

Section "Hum Removal Manual" SecManual
  SetOutPath "$INSTDIR"
  
  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Hum Removal.pdf"
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Hum Removal VST Plugin"

  LangString DESC_SecVSTPlugin ${LANG_ENGLISH} "Hum Removal VST Plugin"
  LangString DESC_SecManual ${LANG_ENGLISH} "Hum Removal Manual"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Hum Removal.dll"
  Delete "$INSTDIR\Hum Removal.pdf"

...
;General
  ...
  ;Name and file
  Name "ReverseVerb Installer"
  OutFile "ReverseVerb_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "ReverseVerb"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\ReverseVerb.dll"
  ${Else}
  File "..\Bin\Win32\VST\ReverseVerb.dll"
  ...
  StrCpy $0 "$INSTDIR\ReverseVerb.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_ReverseVerb.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "ReverseVerb VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "ReverseVerb VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\ReverseVerb.dll"
  Delete "$INSTDIR\ReverseVerb.pdf"

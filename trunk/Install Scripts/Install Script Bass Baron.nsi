...
;General
  ...
  ;Name and file
  Name "Bass Baron Installer"
  OutFile "Bass_Baron_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Bass Baron"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Bass Baron.dll"
  ${Else}
  File "..\Bin\Win32\VST\Bass Baron.dll"
  ...
  StrCpy $0 "$INSTDIR\Bass Baron.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Bass_Baron.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Bass Baron VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Bass Baron VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Bass Baron.dll"
  Delete "$INSTDIR\Bass Baron.pdf"

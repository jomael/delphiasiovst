...
;General
  ...
  ;Name and file
  Name "VSTPascalScript Installer"
  OutFile "VSTPascalScript_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "VSTPascalScript"
...
Section "VST-Plugin" SecVstPlugin
  ...
  StrCpy $0 "$INSTDIR\VSTPascalScript.dll" 

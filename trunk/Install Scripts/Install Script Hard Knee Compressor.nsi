...
;Hard Knee Compressor Installer
...
;General
  ...
  ;Name and file
  Name "Hard Knee Compressor Installer"
  OutFile "Hard_Knee_Compressor_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Hard Knee Compressor"
...
Section "Hard Knee Compressor VST-Plugin" SecVstPlugin
  SetOutPath "$INSTDIR"
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Hard Knee Compressor VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Hard Knee Compressor VST Plugin"

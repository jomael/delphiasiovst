...
;General
  ...
  ;Name and file
  Name "Hysteresis Installer"
  OutFile "Hysteresis_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Hysteresis"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Hysteresis.dll"
  ${Else}
  File "..\Bin\Win32\VST\Hysteresis.dll"
  ...
  StrCpy $0 "$INSTDIR\Hysteresis.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Hysteresis.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Hysteresis VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Hysteresis VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Hysteresis.dll"
  Delete "$INSTDIR\Hysteresis.pdf"

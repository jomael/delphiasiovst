...
;General
  ...
  ;Name and file
  Name "Flanger Installer"
  OutFile "Flanger_Install.exe"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Flanger.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Flanger VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Flanger VST Plugin"

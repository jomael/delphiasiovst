...
;General
  ...
  ;Name and file
  Name "SpinBug Lite Installer"
  OutFile "SpinBug_Lite_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "SpinBug Lite"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\SpinBug Lite.dll"
  ${Else}
  File "..\Bin\Win32\VST\SpinBug Lite.dll"
  ...
  StrCpy $0 "$INSTDIR\SpinBug Lite.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_SpinBug_Lite.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "SpinBug Lite VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "SpinBug Lite VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\SpinBug Lite.dll"
  Delete "$INSTDIR\SpinBug Lite.pdf"

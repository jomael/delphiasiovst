...
;General
  ...
  ;Name and file
  Name "SubBoost Installer"
  OutFile "SubBoost_Install.exe"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\SubBoost.dll"
  ${Else}
  File "..\Bin\Win32\VST\SubBoost.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_SubBoost.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "SubBoost VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "SubBoost VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\SubBoost.dll"
  Delete "$INSTDIR\SubBoost.pdf"

...
;Linkwitz-Riley Separated Installer
...
;General
  ...
  ;Name and file
  Name "Linkwitz-Riley Separated Installer"
  OutFile "Linkwitz-Riley_Separated_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Linkwitz-Riley Separated"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Linkwitz-Riley Separated.dll"
  ${Else}
  File "..\Bin\Win32\VST\Linkwitz-Riley Separated.dll"
  ...
  StrCpy $0 "$INSTDIR\Linkwitz-Riley Separated.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Linkwitz-Riley_Separated.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Linkwitz-Riley Separated VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Linkwitz-Riley Separated VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Linkwitz-Riley Separated.dll"
  Delete "$INSTDIR\Linkwitz-Riley Separated.pdf"

...
;Spectral Delay Filter Installer
...
;General
  ...
  ;Name and file
  Name "Spectral Delay Filter Installer"
  OutFile "Spectral_Delay_Filter_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Spectral Delay Filter"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Spectral Delay Filter.dll"
  ${Else}
  File "..\Bin\Win32\VST\Spectral Delay Filter.dll"
  ...
  StrCpy $0 "$INSTDIR\Spectral Delay Filter.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Spectral_Delay_Filter.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Spectral Delay Filter VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Spectral Delay Filter VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Spectral Delay Filter.dll"
  Delete "$INSTDIR\Spectral Delay Filter.pdf"

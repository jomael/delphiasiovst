...
;General
  ...
  ;Name and file
  Name "Spectral Smoothing Installer"
  OutFile "Spectral_Smoothing_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Spectral Smoothing"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Spectral Smoothing.dll"
  ${Else}
  File "..\Bin\Win32\VST\Spectral Smoothing.dll"
  ...
  StrCpy $0 "$INSTDIR\Spectral Smoothing.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Spectral_Smoothing.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Spectral Smoothing VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Spectral Smoothing VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Spectral Smoothing.dll"
  Delete "$INSTDIR\Spectral Smoothing.pdf"

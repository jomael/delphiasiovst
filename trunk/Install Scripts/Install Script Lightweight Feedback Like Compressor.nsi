...
;Lightweight Feedback Like Compressor Installer
...
;General
  ...
  ;Name and file
  Name "Lightweight Feedback Like Compressor Installer"
  OutFile "Lightweight_Feedback_Like_Compressor_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Lightweight Feedback Like Compressor"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Lightweight Feedback Like Compressor.dll"
  ${Else}
  File "..\Bin\Win32\VST\Lightweight Feedback Like Compressor.dll"
  ...
  StrCpy $0 "$INSTDIR\Lightweight Feedback Like Compressor.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Lightweight_Feedback_Like_Compressor.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Lightweight Feedback Like Compressor VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Lightweight Feedback Like Compressor VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Lightweight Feedback Like Compressor.dll"
  Delete "$INSTDIR\Lightweight Feedback Like Compressor.pdf"

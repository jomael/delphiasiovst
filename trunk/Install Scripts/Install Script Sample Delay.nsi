...
;General
  ...
  ;Name and file
  Name "Sample Delay Installer"
  OutFile "Sample_Delay_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Sample Delay"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Sample Delay.dll"
  ${Else}
  File "..\Bin\Win32\VST\Sample Delay.dll"
  ...
  StrCpy $0 "$INSTDIR\Sample Delay.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Sample_Delay.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Sample Delay VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Sample Delay VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Sample Delay.dll"
  Delete "$INSTDIR\Sample Delay.pdf"

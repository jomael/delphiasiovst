...
;General
  ...
  ;Name and file
  Name "Lookahead Gate Installer"
  OutFile "Lookahead_Gate_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Lookahead Gate"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Lookahead Gate.dll"
  ${Else}
  File "..\Bin\Win32\VST\Lookahead Gate.dll"
  ...
  StrCpy $0 "$INSTDIR\Lookahead Gate.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Lookahead_Gate.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Lookahead Gate VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Lookahead Gate VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Lookahead Gate.dll"
  Delete "$INSTDIR\Lookahead Gate.pdf"

...
;General
  ...
  ;Name and file
  Name "Simple Sample Delay Installer"
  OutFile "Simple_Sample_Delay_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Simple Sample Delay"
...
Section "Simple Sample Delay VST-Plugin" SecVstPlugin
  SetOutPath "$INSTDIR"
  
  !system 'copy "..\Bin\SimpleSampleDelay.dll" "..\Bin\Simple Sample Delay.dll"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Simple Sample Delay.dll"
  ...
  StrCpy $0 "$INSTDIR\Simple Sample Delay.dll" 
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Simple_Sample_Delay.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Simple Sample Delay VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Simple Sample Delay VST Plugin"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Simple Sample Delay.dll"

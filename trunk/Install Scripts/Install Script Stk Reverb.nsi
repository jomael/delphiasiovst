...
;General
  ...
  ;Name and file
  Name "Stk Reverb Installer"
  OutFile "Stk_Reverb_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Stk Reverb"
...
Section "Stk Reverb VST-Plugin" SecVstPlugin
  SetOutPath "$INSTDIR"
  
  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\StkReverb.dll"
  ...
  StrCpy $0 "$INSTDIR\StkReverb.dll" 
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Stk Reverb VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Stk Reverb VST Plugin"

...
;General
  ...
  ;Name and file
  Name "Difference & Gain Installer"
  OutFile "Difference_&_Gain_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Difference & Gain"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Difference & Gain.dll"
  ${Else}
  File "..\Bin\Win32\VST\Difference & Gain.dll"
  ...
  StrCpy $0 "$INSTDIR\Difference & Gain.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Difference_&_Gain.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Difference & Gain VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Difference & Gain VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Difference & Gain.dll"
  Delete "$INSTDIR\Difference & Gain.pdf"

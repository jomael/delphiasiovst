...
;General
  ...
  ;Name and file
  Name "Sorted Disorder Installer"
  OutFile "Sorted_Disorder_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Sorted Disorder"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Sorted Disorder.dll"
  ${Else}
  File "..\Bin\Win32\VST\Sorted Disorder.dll"
  ...
  StrCpy $0 "$INSTDIR\Sorted Disorder.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Sorted_Disorder.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Sorted Disorder VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Sorted Disorder VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Sorted Disorder.dll"
  Delete "$INSTDIR\Sorted Disorder.pdf"

...
Section "Vocoder VST-Plugin" SecVstPlugin
  SetOutPath "$INSTDIR"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Vocoder.exe"
SectionEnd
...
;Descriptions
  ...
  ;Language strings
  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Vocoder VST Plugin"

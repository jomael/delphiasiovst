...
;General
  ...
  ;Name and file
  Name "Schaebichef Installer"
  OutFile "Schaebichef_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Schaebichef"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Schaebichef.dll"
  ${Else}
  File "..\Bin\Win32\VST\Schaebichef.dll"
  ...
  StrCpy $0 "$INSTDIR\Schaebichef.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Schaebichef.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Schaebichef VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Schaebichef VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Schaebichef.dll"
  Delete "$INSTDIR\Schaebichef.pdf"

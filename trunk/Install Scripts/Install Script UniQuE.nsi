...
;General
  ...
  ;Name and file
  Name "UniQuE Installer"
  OutFile "UniQuE_Install.exe"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\UniQuE.dll"
  ${Else}
  File "..\Bin\Win32\VST\UniQuE.dll"
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "UniQuE VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "UniQuE VST Plugin"

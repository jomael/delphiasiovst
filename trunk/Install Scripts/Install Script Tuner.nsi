...
;General
  ...
  ;Name and file
  Name "Tuner Installer"
  OutFile "Tuner_Install.exe"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Tuner.dll"
  ${Else}
  File "..\Bin\Win32\VST\Tuner.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Tuner.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Tuner VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Tuner VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Tuner.dll"
  Delete "$INSTDIR\Tuner.pdf"

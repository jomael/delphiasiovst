...
;LinearPhase Crossover Installer
...
;General
  ...
  ;Name and file
  Name "LinearPhase Crossover Installer"
  OutFile "LinearPhase_Crossover_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "LinearPhase Crossover"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\LinearPhase Crossover.dll"
  ${Else}
  File "..\Bin\Win32\VST\LinearPhase Crossover.dll"
  ...
  StrCpy $0 "$INSTDIR\LinearPhase Crossover.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_LinearPhase_Crossover.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "LinearPhase Crossover VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "LinearPhase Crossover VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\LinearPhase Crossover.dll"
  Delete "$INSTDIR\LinearPhase Crossover.pdf"

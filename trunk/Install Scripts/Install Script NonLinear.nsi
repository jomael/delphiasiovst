...
;General
  ...
  ;Name and file
  Name "NonLinear Installer"
  OutFile "NonLinear_Install.exe"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\NonLinear.dll"
  ${Else}
  File "..\Bin\Win32\VST\NonLinear.dll"
  ...
  StrCpy $0 "$INSTDIR\NonLinear.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_NonLinear.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "NonLinear VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "NonLinear VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\NonLinear.dll"
  Delete "$INSTDIR\NonLinear.pdf"

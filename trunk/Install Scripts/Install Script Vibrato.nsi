...
;General
  ...
  ;Name and file
  Name "Vibrato Installer"
  OutFile "Vibrato_Install.exe"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Vibrato.dll"
  ${Else}
  File "..\Bin\Win32\VST\Vibrato.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Vibrato.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Vibrato VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Vibrato VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Vibrato.dll"
  Delete "$INSTDIR\Vibrato.pdf"

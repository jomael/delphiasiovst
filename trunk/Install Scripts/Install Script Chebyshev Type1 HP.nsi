...
;General
  ...
  ;Name and file
  Name "Chebyshev Type1 HP Installer"
  OutFile "Chebyshev_Type1_HP_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Chebyshev Type1 HP"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Chebyshev Type1 HP.dll"
  ${Else}
  File "..\Bin\Win32\VST\Chebyshev Type1 HP.dll"
  ...
  StrCpy $0 "$INSTDIR\Chebyshev Type1 HP.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Chebyshev_Type1_HP.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Chebyshev Type1 HP VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Chebyshev Type1 HP VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Chebyshev Type1 HP.dll"
  Delete "$INSTDIR\Chebyshev Type1 HP.pdf"

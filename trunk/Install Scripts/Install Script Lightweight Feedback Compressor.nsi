...
;General
  ...
  ;Name and file
  Name "Lightweight Feedback Compressor Installer"
  OutFile "Lightweight_Feedback_Compressor_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Lightweight Feedback Compressor"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Lightweight Feedback Compressor.dll"
  ${Else}
  File "..\Bin\Win32\VST\Lightweight Feedback Compressor.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Lightweight_Feedback_Compressor.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Lightweight Feedback Compressor VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Lightweight Feedback Compressor VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Lightweight Feedback Compressor.pdf"

...
Section "Delayla VST-Plugin" SecVstPlugin
  SetOutPath "$INSTDIR"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Delayla.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Delayla VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Delayla VST Plugin"

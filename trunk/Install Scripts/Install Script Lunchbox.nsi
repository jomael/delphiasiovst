...
;General
  ...
  ;Name and file
  Name "Lunchbox Installer"
  OutFile "Lunchbox_Install.exe"
...
Section "ASIO Lunchbox" SecProgramFiles
  SetOutPath "$INSTDIR"
  
  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Lunchbox.exe"

...
type
  TCustomTestConvertToFloat32 = class(TTestCase)
  strict protected
...
procedure TCustomTestConvertToFloat32.SetUp;
begin
 inherited;
...
procedure TCustomTestConvertToFloat32.TearDown;
begin
...
procedure TCustomTestConvertInt16ToFloat32.PerformSimpleTest;
var
  SampleIndex  : Integer;
...
begin
 ...
 for SampleIndex := 0 to FAudioMemory32.SampleCount - 1
  do CheckEquals((SampleIndex / $7FFF), FAudioMemory32.DataPointer^[SampleIndex], 1E-7);
end;
...
begin
 ...
 CheckEquals(1 / $7FFF, FAudioMemory32.Data[1], 1E-7);
 ...
 for SampleIndex := 1 to FAudioMemory32.SampleCount - 17
  do CheckEquals(((SampleIndex + 1) / $7FFF), FAudioMemory32.DataPointer^[SampleIndex], 1E-7);
end;
...
begin
 ...
 // convert integer data to float
 BlockConvertInt24LSBToFloat32(PSingle(FAudioMemory32.DataPointer), FData,
   FAudioMemory32.SampleCount);
...
begin
 // use processor specific binding
 BindingBlockConvertInt24LSBToFloat32.RebindProcessorSpecific;
...
begin
 ...
 // convert integer data to float
 BlockConvertInt24LSBToFloat32(FloatPointer, DataPointer, 1);
 ...
 // convert integer data to float
 BlockConvertInt24LSBToFloat32(FloatPointer, DataPointer,
   FAudioMemory32.SampleCount - 17);
...
begin
 // use compatibility binding
 BindingBlockConvertInt24LSBToFloat32.Rebind([]);
...
begin
 // use SSE/SSE2 binding
 BindingBlockConvertInt24LSBToFloat32.Rebind([pfSSE, pfSSE2]);
...
initialization
  // LSB
  RegisterTest(TTestConvertInt16LSBToFloat32.Suite);
  RegisterTest(TTestConvertInt24LSBToFloat32.Suite);
  RegisterTest(TTestConvertInt32LSBToFloat32.Suite);
  RegisterTest(TTestConvertInt32LSB16ToFloat32.Suite);
  RegisterTest(TTestConvertInt32LSB18ToFloat32.Suite);
  RegisterTest(TTestConvertInt32LSB20ToFloat32.Suite);
  RegisterTest(TTestConvertInt32LSB24ToFloat32.Suite);

  // MSB
  RegisterTest(TTestConvertInt16MSBToFloat32.Suite);
  RegisterTest(TTestConvertInt24MSBToFloat32.Suite);
  RegisterTest(TTestConvertInt32MSBToFloat32.Suite);
  RegisterTest(TTestConvertInt32MSB16ToFloat32.Suite);
  RegisterTest(TTestConvertInt32MSB18ToFloat32.Suite);
  RegisterTest(TTestConvertInt32MSB20ToFloat32.Suite);
  RegisterTest(TTestConvertInt32MSB24ToFloat32.Suite);

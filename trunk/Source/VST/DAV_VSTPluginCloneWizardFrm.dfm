object VSTPluginCloneWizardForm: TVSTPluginCloneWizardForm
  Left = 291
  Top = 81
  HorzScrollBar.Visible = False
  VertScrollBar.Visible = False
  BorderStyle = bsDialog
  Caption = 'VST Plugin Clone Wizard'
  ClientHeight = 345
  ClientWidth = 452
  Color = clBtnFace
  ...
  object PageControl: TPageControl
    ...
    object TSWelcome: TTabSheet
      ...
      object LbWelcomeInstructions4: TLabel
        ...
        Width = 211
        Height = 13
        Caption = 'Click "Next" to start cloning your VST plugin.'
      end
      object LbWelcomeInstructions3: TLabel
        ...
        Caption = 
          ...
          'ost application such as Steinberg Cubase, but you need to implem' +
          'ent all missing details to complete the clone.'
        WordWrap = True
      end
      object LbWelcomeInstructions2: TLabel
        ...
        Height = 52
        Caption = 
          'The cloning process will scan the selected plugin for its parame' +
          'ters and programs. Based on this a TVSTModule descendant class w' +
          'ill be created similar to the original plugin, but without any D' +
          'SP code. Optionally, a GUI editor form is created as well.'
        WordWrap = True
      end
      object LbWelcomeInstructions1: TLabel
        ...
        Height = 13
        Caption = 
          'This wizard will guide you through the process of cloning a VST ' +
          'plugin.'
        WordWrap = True
      end
    end
    ...
    object TSPluginType: TTabSheet
      ...
      object LbSelectVSTTypeInstruction: TLabel
        ...
        Width = 252
        Height = 13
        Caption = 'Select the original plugin you would like to be cloned:'
        WordWrap = True
      end
      object EdClonedPlugin: TEdit
        Left = 24
        Top = 59
        Width = 321
        Height = 21

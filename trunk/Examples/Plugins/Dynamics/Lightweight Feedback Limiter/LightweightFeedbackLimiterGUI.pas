unit LightweightFeedbackLimiterGUI;
...
uses
  {$IFDEF FPC}LCLIntf, LResources, {$ELSE} Windows, {$ENDIF} SysUtils, Classes, Forms, Controls, ExtCtrls, DAV_Types,
...
procedure TFmLightweightFeedbackLimiter.FormShow(Sender: TObject);
begin
 UpdateAttack;
 UpdateRelease;
 UpdateThreshold;
...
procedure TFmLightweightFeedbackLimiter.LEDAutoGainClick(Sender: TObject);
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
  begin
...
procedure TFmLightweightFeedbackLimiter.LEDLimitClick(Sender: TObject);
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
  begin
...
procedure TFmLightweightFeedbackLimiter.LEDStereoClick(Sender: TObject);
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
  begin
...
procedure TFmLightweightFeedbackLimiter.TimerTimer(Sender: TObject);
begin
 with TLightweightFeedbackLimiterDataModule(Owner), LMGainReduction do
  begin
   if LightweightFeedbackLimiter[0].GainReductiondB > PeakLevel
    then PeakLevel := LightweightFeedbackLimiter[0].GainReductiondB
    else PeakLevel := 0.5 * PeakLevel - 0.5 * LightweightFeedbackLimiter[0].GainReductiondB;
  end;
end;

procedure TFmLightweightFeedbackLimiter.DialAttackChange(Sender: TObject);
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
  begin
...
procedure TFmLightweightFeedbackLimiter.DialReleaseChange(Sender: TObject);
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
  begin
...
procedure TFmLightweightFeedbackLimiter.DialThresholdChange(Sender: TObject);
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
  begin
...
function TFmLightweightFeedbackLimiter.EvaluateCharacteristic(Sender: TObject;
  X: Double): Double;
begin
 result := TLightweightFeedbackLimiterDataModule(Owner).EvaluateCharacteristic(X);
end;

procedure TFmLightweightFeedbackLimiter.DialKneeChange(Sender: TObject);
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
  begin
...
procedure TFmLightweightFeedbackLimiter.DialMakeUpGainChange(Sender: TObject);
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
  begin
...
procedure TFmLightweightFeedbackLimiter.UpdateAttack;
var
  Attack : Single;
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
...
procedure TFmLightweightFeedbackLimiter.UpdateRelease;
var
  Release : Single;
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
...
procedure TFmLightweightFeedbackLimiter.UpdateKnee;
var
  Knee : Single;
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
...
procedure TFmLightweightFeedbackLimiter.UpdateMakeUp;
var
  MakeUp : Single;
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
  begin
   MakeUp := LightweightFeedbackLimiter[0].MakeUpGain_dB;
...
procedure TFmLightweightFeedbackLimiter.UpdateThreshold;
var
  Threshold : Single;
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
...
procedure TFmLightweightFeedbackLimiter.UpdateStereo;
var
  Brightness : Single;
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
...
procedure TFmLightweightFeedbackLimiter.UpdateAutoMakeUpGain;
var
  Brightness : Single;
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do
...
procedure TFmLightweightFeedbackLimiter.UpdateLimit;
var
  Brightness : Single;
begin
 with TLightweightFeedbackLimiterDataModule(Owner) do

...
var
  NewVec : array[0..31] of Single;  // new V[0-15] and V[33-48] of Figure 3-A.2 in ISO DIS 11172-3
...
begin
 ...
 if (FActualVector = @FVector[0])
  then x[1] := @FVector[1, FActualWritePos]
  else x[1] := @FVector[0, FActualWritePos];

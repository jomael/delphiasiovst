...
type
  ...
  THuffmanCodeTable = record
    TableName  : array[0..2] of AnsiChar; // string, containing table_description
...
var
  ...
  //   32, 33 count1 - tables
  GHuffmanCodeTable: array[0..CHuffmanCodeTableSize - 1] of THuffmanCodeTable;
...
const
  ...
  CValTab0: array[0..0] of THTArray = (
    (0,0));  // dummy

  CValTab1: array[0..6] of THTArray = (
    (2,1),(0,0),(2,1),(0,16),(2,1),(0,1),(0,17));

  CValTab2: array[0..16] of THTArray = (
    (2,1),(0,0),(4,1),(2,1),(0,16),(0,1),(2,1),(0,17),(4,1),(2,1),
    (0,32),(0,33),(2,1),(0,18),(2,1),(0,2),(0,34));

  CValTab3: array[0..16] of THTArray = (
    (4,1),(2,1),(0,0),(0,1),(2,1),(0,17),(2,1),(0,16),(4,1),(2,1),
    (0,32),(0,33),(2,1),(0,18),(2,1),(0,2),(0,34));

  CValTab4: array[0..0] of THTArray = (
    (0,0));  // dummy

  CValTab5: array[0..30] of THTArray = (
  ...
  CValTab6: array[0..30] of THTArray = (
  ...
  CValTab7: array[0..70] of THTArray = (
  ...
  CValTab8: array[0..70] of THTArray = (
  ...
  CValTab9: array[0..70] of THTArray = (
  ...
  CValTab10: array[0..126] of THTArray = (
  ...
  CValTab11: array[0..126] of THTArray = (
  ...
  CValTab12: array[0..126] of THTArray = (
  ...
  CValTab13: array[0..510] of THTArray = (
  ...
  CValTab14: array[0..0] of THTArray = (
    (0,0));  // dummy

  CValTab15: array[0..510] of THTArray = (
  ...
  CValTab16: array[0..510] of THTArray = (
  ...
  CValTab24: array[0..511] of THTArray = (
  ...
  CValTab32: array[0..30] of THTArray = (
  ...
  CValTab33: array[0..30] of THTArray = (
...
begin
 ...
 repeat
  ...
  if (BitReverse.Get1Bit <> 0) then
   begin
    while (HuffmanCodeTable.Val[Point, 1] >= CMaxOff)
     do Point := Point + HuffmanCodeTable.Val[Point, 1];
    Point := Point + HuffmanCodeTable.Val[Point, 1];
   end
  else
   begin
    while (HuffmanCodeTable.Val[Point, 0] >= CMaxOff)
     do Point := Point + HuffmanCodeTable.Val[Point, 0];
    Point := Point + HuffmanCodeTable.Val[Point, 0];
   end;

  Level := Level shr 1;
 until not ((Level <> 0) or (Point < PHuffmanCodeTable(@GHuffmanCodeTable).TreeLength));

 // Process sign encodings for quadruples tables.
 if (HuffmanCodeTable.TableName[0] = '3') and (
    (HuffmanCodeTable.TableName[1] = '2') or (HuffmanCodeTable.TableName[1] = '3')) then
  begin
   v := (y shr 3) and 1;
   w := (y shr 2) and 1;
   x := (y shr 1) and 1;
...
begin
 SetHuffTable(@GHuffmanCodeTable[0], '0', 0, 0, 0, 0, -1, nil, nil, @CValTab0, 0);
 SetHuffTable(@GHuffmanCodeTable[1], '1', 2, 2, 0, 0, -1, nil, nil, @CValTab1, 7);
 SetHuffTable(@GHuffmanCodeTable[2], '2', 3, 2, 0, 0, -1, nil, nil, @CValTab2, 17);
 SetHuffTable(@GHuffmanCodeTable[3], '3', 3, 3, 0, 0, -1, nil, nil, @CValTab3, 17);
 SetHuffTable(@GHuffmanCodeTable[4], '4', 0, 0, 0, 0, -1, nil, nil, @CValTab4, 0);
 SetHuffTable(@GHuffmanCodeTable[5], '5', 4, 4, 0, 0, -1, nil, nil, @CValTab5, 31);
 SetHuffTable(@GHuffmanCodeTable[6], '6', 4, 4, 0, 0, -1, nil, nil, @CValTab6, 31);
 SetHuffTable(@GHuffmanCodeTable[7], '7', 6, 6, 0, 0, -1, nil, nil, @CValTab7, 71);
 SetHuffTable(@GHuffmanCodeTable[8], '8', 6, 6, 0, 0, -1, nil, nil, @CValTab8, 71);
 SetHuffTable(@GHuffmanCodeTable[9], '9', 6, 6, 0, 0, -1, nil, nil, @CValTab9, 71);

 SetHuffTable(@GHuffmanCodeTable[10], '10', 8, 8, 0, 0, -1, nil, nil, @CValTab10, 127);
 SetHuffTable(@GHuffmanCodeTable[11], '11', 8, 8, 0, 0, -1, nil, nil, @CValTab11, 127);
 SetHuffTable(@GHuffmanCodeTable[12], '12', 8, 8, 0, 0, -1, nil, nil, @CValTab12, 127);
 SetHuffTable(@GHuffmanCodeTable[13], '13', 16, 16, 0, 0, -1, nil, nil, @CValTab13, 511);
 SetHuffTable(@GHuffmanCodeTable[14], '14', 0, 0, 0, 0, -1, nil, nil, @CValTab14, 0);
 SetHuffTable(@GHuffmanCodeTable[15], '15', 16, 16, 0, 0, -1, nil, nil, @CValTab15, 511);
 SetHuffTable(@GHuffmanCodeTable[16], '16', 16, 16, 1, 1, -1, nil, nil, @CValTab16, 511);
 SetHuffTable(@GHuffmanCodeTable[17], '17', 16, 16, 2, 3, 16, nil, nil, @CValTab16, 511);
 SetHuffTable(@GHuffmanCodeTable[18], '18', 16, 16, 3, 7, 16, nil, nil, @CValTab16, 511);
 SetHuffTable(@GHuffmanCodeTable[19], '19', 16, 16, 4, 15, 16, nil, nil, @CValTab16, 511);

 SetHuffTable(@GHuffmanCodeTable[20], '20', 16, 16, 6, 63, 16, nil, nil, @CValTab16, 511);
 SetHuffTable(@GHuffmanCodeTable[21], '21', 16, 16, 8, 255, 16, nil, nil, @CValTab16, 511);
 SetHuffTable(@GHuffmanCodeTable[22], '22', 16, 16, 10, 1023, 16, nil, nil, @CValTab16, 511);
 SetHuffTable(@GHuffmanCodeTable[23], '23', 16, 16, 13, 8191, 16, nil, nil, @CValTab16, 511);
 SetHuffTable(@GHuffmanCodeTable[24], '24', 16, 16, 4, 15, -1, nil, nil, @CValTab24, 512);
 SetHuffTable(@GHuffmanCodeTable[25], '25', 16, 16, 5, 31, 24, nil, nil, @CValTab24, 512);
 SetHuffTable(@GHuffmanCodeTable[26], '26', 16, 16, 6, 63, 24, nil, nil, @CValTab24, 512);
 SetHuffTable(@GHuffmanCodeTable[27], '27', 16, 16, 7, 127, 24, nil, nil, @CValTab24, 512);
 SetHuffTable(@GHuffmanCodeTable[28], '28', 16, 16, 8, 255, 24, nil, nil, @CValTab24, 512);
 SetHuffTable(@GHuffmanCodeTable[29], '29', 16, 16, 9, 511, 24, nil, nil, @CValTab24, 512);

 SetHuffTable(@GHuffmanCodeTable[30], '30', 16, 16, 11, 2047, 24, nil, nil, @CValTab24, 512);
 SetHuffTable(@GHuffmanCodeTable[31], '31', 16, 16, 13, 8191, 24, nil, nil, @CValTab24, 512);
 SetHuffTable(@GHuffmanCodeTable[32], '32', 1, 16, 0, 0, -1, nil, nil, @CValTab32, 31);
 SetHuffTable(@GHuffmanCodeTable[33], '33', 1, 16, 0, 0, -1, nil, nil, @CValTab32, 31);
end.

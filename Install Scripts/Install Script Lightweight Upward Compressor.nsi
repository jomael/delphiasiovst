...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Lightweight Upward Compressor.dll"
  ${Else}
  File "..\Bin\Win32\VST\Lightweight Upward Compressor.dll"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Lightweight Upward Compressor.dll"
  Delete "$INSTDIR\Lightweight Upward Compressor.pdf"

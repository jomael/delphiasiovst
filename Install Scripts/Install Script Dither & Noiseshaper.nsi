...
;General
  ...
  ;Name and file
  Name "Dither & Noiseshaper Installer"
  OutFile "Dither_Noiseshaper_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Dither & Noiseshaper"
...
Section "VST-Plugin" SecVstPlugin
  ...
  StrCpy $0 "$INSTDIR\Dither & Noiseshaper.dll" 
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Dither & Noiseshaper VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Dither & Noiseshaper VST Plugin"
...
Section "Uninstall"
  ...
  ${If} ${RunningX64}
  Delete "$INSTDIR\Dither & Noiseshaper.dll"
  ${Else}
  Delete "$INSTDIR\Dither & Noiseshaper.dll"
  ${Endif}

...
;Lightweight Dynamics Installer
...
;General
  ...
  ;Name and file
  Name "Lightweight Dynamics Installer"
  OutFile "Lightweight_Dynamics_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Lightweight Dynamics"
...
Section "Lightweight Dynamics VST-Plugin" SecVSTPlugin
  SetOutPath "$INSTDIR"
  
  !system 'copy "..\Bin\LightweightDynamics.dll" "..\Bin\Lightweight Dynamics.dll"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Lightweight Dynamics.dll"
  ...
  StrCpy $0 "$INSTDIR\Lightweight Dynamics.dll" 
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Lightweight_Dynamics.exe"
SectionEnd

Section "Lightweight Dynamics Manual" SecManual
  SetOutPath "$INSTDIR"
  
  ;ADD YOUR OWN FILES HERE...
;  File "..\Bin\Lightweight Dynamics Manual.pdf"
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Lightweight Dynamics VST Plugin"

  LangString DESC_SecVSTPlugin ${LANG_ENGLISH} "Lightweight Dynamics VST Plugin"
  LangString DESC_SecManual ${LANG_ENGLISH} "Lightweight Dynamics Manual"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Lightweight Dynamics.dll"
  Delete "$INSTDIR\Lightweight Dynamics Manual.pdf"

...
;Granular Pitchshifter Installer
...
;General
  ...
  ;Name and file
  Name "Granular Pitchshifter Installer"
  OutFile "Granular_Pitchshifter_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Granular Pitchshifter"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Granular Pitchshifter.dll"
  ${Else}
  File "..\Bin\Win32\VST\Granular Pitchshifter.dll"
  ...
  StrCpy $0 "$INSTDIR\Granular Pitchshifter.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Granular_Pitchshifter.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Granular Pitchshifter VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Granular Pitchshifter VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Granular Pitchshifter.dll"
  Delete "$INSTDIR\Granular Pitchshifter.pdf"

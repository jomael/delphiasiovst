...
;General
  ...
  ;Name and file
  Name "Oversampled Tanh Installer"
  OutFile "Oversampled_Tanh_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Oversampled Tanh"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Oversampled Tanh.dll"
  ${Else}
  File "..\Bin\Win32\VST\Oversampled Tanh.dll"
  ...
  StrCpy $0 "$INSTDIR\Oversampled Tanh.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Oversampled_Tanh.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Oversampled Tanh VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Oversampled Tanh VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Oversampled Tanh.dll"
  Delete "$INSTDIR\Oversampled Tanh.pdf"

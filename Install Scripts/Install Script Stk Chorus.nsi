...
;General
  ...
  ;Name and file
  Name "Stk Chorus Installer"
  OutFile "Stk_Chorus_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Stk Chorus"
...
Section "Stk Chorus VST-Plugin" SecVstPlugin
  SetOutPath "$INSTDIR"
  
  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\StkChorus.dll"
  ...
  StrCpy $0 "$INSTDIR\StkChorus.dll" 
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_StkChorus.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Stk Chorus VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Stk Chorus VST Plugin"

...
;General
  ...
  ;Name and file
  Name "Phase Rotator Installer"
  OutFile "Phase_Rotator_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Phase Rotator"
...
Section "Phase Rotator VST-Plugin" SecVstPlugin
  SetOutPath "$INSTDIR"
  
  !system 'copy "..\Bin\PhaseRotator.dll" "..\Bin\Phase Rotator.dll"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Phase Rotator.dll"
  ...
  StrCpy $0 "$INSTDIR\Phase Rotator.dll" 
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Phase_Rotator.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Phase Rotator VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Phase Rotator VST Plugin"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Phase Rotator.dll"

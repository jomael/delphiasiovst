...
;Requantized Peak EQ Filter Installer
...
;General
  ...
  ;Name and file
  Name "Requantized Peak EQ Filter Installer"
  OutFile "Requantized_Peak_EQ_Filter_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Requantized Peak EQ Filter"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Requantized Peak EQ Filter.dll"
  ${Else}
  File "..\Bin\Win32\VST\Requantized Peak EQ Filter.dll"
  ...
  StrCpy $0 "$INSTDIR\Requantized Peak EQ Filter.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Requantized_Peak_EQ_Filter.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Requantized Peak EQ Filter VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Requantized Peak EQ Filter VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Requantized Peak EQ Filter.dll"
  Delete "$INSTDIR\Requantized Peak EQ Filter.pdf"

...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Lightweight Multiband Compressor.dll"
  ${Else}
  File "..\Bin\Win32\VST\Lightweight Multiband Compressor.dll"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Lightweight Multiband Compressor.pdf"

...
;General
  ...
  ;Name and file
  Name "Linear Phase HP Installer"
  OutFile "Linear_Phase_HP_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Linear Phase HP"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Linear Phase HP.dll"
  ${Else}
  File "..\Bin\Win32\VST\Linear Phase HP.dll"
  ...
  StrCpy $0 "$INSTDIR\Linear Phase HP.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Linear_Phase_HP.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Linear Phase HP VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Linear Phase HP VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Linear Phase HP.pdf"

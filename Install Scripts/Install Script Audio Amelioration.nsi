...
;General
  ...
  ;Name and file
  Name "Audio Amelioration Installer"
  OutFile "Audio_Amelioration_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Audio Amelioration"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Audio Amelioration.dll"
  ${Else}
  File "..\Bin\Win32\VST\Audio Amelioration.dll"
  ...
  StrCpy $0 "$INSTDIR\Audio Amelioration.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Audio_Amelioration.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Audio Amelioration VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Audio Amelioration VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Audio Amelioration.dll"
  Delete "$INSTDIR\Audio Amelioration.pdf"

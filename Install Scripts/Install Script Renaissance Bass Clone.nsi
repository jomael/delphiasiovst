...
;Renaissance Bass Clone Installer
...
;General
  ...
  ;Name and file
  Name "Renaissance Bass Clone Installer"
  OutFile "Renaissance_Bass_Clone_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Renaissance Bass Clone"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Renaissance Bass Clone.dll"
  ${Else}
  File "..\Bin\Win32\VST\Renaissance Bass Clone.dll"
  ...
  StrCpy $0 "$INSTDIR\Renaissance Bass Clone.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Renaissance_Bass_Clone.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Renaissance Bass Clone VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Renaissance Bass Clone VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Renaissance Bass Clone.dll"
  Delete "$INSTDIR\Renaissance Bass Clone.pdf"

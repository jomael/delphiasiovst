...
;General
  ...
  ;Name and file
  Name "Simple Flanger Installer"
  OutFile "Simple_Flanger_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Simple Flanger"
...
Section "Simple Flanger VST-Plugin" SecVstPlugin
  SetOutPath "$INSTDIR"
  
  !system 'copy "..\Bin\SimpleFlanger.dll" "..\Bin\Simple Flanger.dll"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Simple Flanger.dll"
  ...
  StrCpy $0 "$INSTDIR\Simple Flanger.dll" 
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Simple_Flanger.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Simple Flanger VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Simple Flanger VST Plugin"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Simple Flanger.dll"

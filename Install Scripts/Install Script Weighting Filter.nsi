...
;General
  ...
  ;Name and file
  Name "Weighting Filter Installer"
  OutFile "Weighting_Filter_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Weighting Filter"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Weighting Filter.dll"
  ${Else}
  File "..\Bin\Win32\VST\Weighting Filter.dll"
  ...
  StrCpy $0 "$INSTDIR\Weighting Filter.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Weighting_Filter.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Weighting Filter VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Weighting Filter VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Weighting Filter.dll"
  Delete "$INSTDIR\Weighting Filter.pdf"

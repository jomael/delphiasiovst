...
;General
  ...
  ;Name and file
  Name "MIDI PluglIn Installer"
  OutFile "MIDI_PluglIn_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "MIDI PluglIn"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\MIDI PluglIn.dll"
  ${Else}
  File "..\Bin\Win32\VST\MIDI PluglIn.dll"
  ...
  StrCpy $0 "$INSTDIR\MIDI PluglIn.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_MIDI_PluglIn.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "MIDI PluglIn VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "MIDI PluglIn VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\MIDI PluglIn.dll"
  Delete "$INSTDIR\MIDI PluglIn.pdf"

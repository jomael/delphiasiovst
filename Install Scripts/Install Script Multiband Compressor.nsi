...
;Multiband Compressor Installer
...
;General
  ...
  ;Name and file
  Name "Multiband Compressor Installer"
  OutFile "Multiband_Compressor_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Multiband Compressor"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Multiband Compressor.dll"
  ${Else}
  File "..\Bin\Win32\VST\Multiband Compressor.dll"
  ...
  StrCpy $0 "$INSTDIR\Multiband Compressor.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Multiband_Compressor.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Multiband Compressor VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Multiband Compressor VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Multiband Compressor.dll"
  Delete "$INSTDIR\Multiband Compressor.pdf"

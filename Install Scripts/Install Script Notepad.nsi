...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Notepad.dll"
  ${Else}
  File "..\Bin\Win32\VST\Notepad.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Notepad.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Notepad VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Notepad VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Notepad.dll"
  Delete "$INSTDIR\Notepad.pdf"

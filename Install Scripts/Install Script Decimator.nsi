...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Decimator.dll"
  ${Else}
  File "..\Bin\Win32\VST\Decimator.dll"
  ...
  StrCpy $0 "$INSTDIR\Decimator.dll"
...
;Descriptions
  ...
  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Decimator VST Plugin"

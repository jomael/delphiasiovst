...
;Dual Linkwitz-Riley Filters Installer
...
;General
  ...
  ;Name and file
  Name "Dual Linkwitz-Riley Filters Installer"
  OutFile "Dual_Linkwitz-Riley_Filters_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Dual Linkwitz-Riley Filters"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Dual Linkwitz-Riley Filters.dll"
  ${Else}
  File "..\Bin\Win32\VST\Dual Linkwitz-Riley Filters.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Dual_Linkwitz-Riley_Filters.exe"
SectionEnd
...
Section "Manual" SecManual
  ...
  File "..\Manuals\Dual Linkwitz-Riley Filters.pdf"
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Dual Linkwitz-Riley Filters VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Dual Linkwitz-Riley Filters VST Plugin"
  LangString DESC_SecManual ${LANG_ENGLISH} "Dual Linkwitz-Riley Filters Manual"

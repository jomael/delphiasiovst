...
;Interface Settings
  ...
  !define PRODUCT_NAME "Enhanced Gate"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Enhanced Gate.dll"
  ${Else}
  File "..\Bin\Win32\VST\Enhanced Gate.dll"
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Enhanced Gate VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Enhanced Gate VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Enhanced Gate.pdf"

...
;General
  ...
  ;Name and file
  Name "LA4029 Installer"
  OutFile "LA4029_Install.exe"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\LA4029.dll"
  ${Else}
  File "..\Bin\Win32\VST\LA4029.dll"
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "LA4029 VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "LA4029 VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\LA4029.dll"
  Delete "$INSTDIR\LA4029.pdf"

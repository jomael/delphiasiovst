...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Plate Reverb.dll"
  ${Else}
  File "..\Bin\Win32\VST\Plate Reverb.dll"
  ...
  StrCpy $0 "$INSTDIR\Plate Reverb.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Plate_Reverb.exe"
SectionEnd
...
;Descriptions
  ...
  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Plate Reverb VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Plate Reverb.pdf"

...
;General
  ...
  ;Name and file
  Name "Stk Echo Installer"
  OutFile "Stk_Echo_Install.exe"
...
Section "Stk Echo VST-Plugin" SecVstPlugin
  SetOutPath "$INSTDIR"
  
  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\StkEcho.dll"
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Stk Echo VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Stk Echo VST Plugin"

...
;General
  ...
  ;Name and file
  Name "ASIO-Extender Installer"
  OutFile "ASIO-Extender_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "ASIO-Extender"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\ASIO-Extender.dll"
  ${Else}
  File "..\Bin\Win32\VST\ASIO-Extender.dll"
  ...
  StrCpy $0 "$INSTDIR\ASIO-Extender.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_ASIO-Extender.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "ASIO-Extender VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "ASIO-Extender VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\ASIO-Extender.dll"
  Delete "$INSTDIR\ASIO-Extender.pdf"

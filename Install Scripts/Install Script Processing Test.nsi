...
;General
  ...
  ;Name and file
  Name "Processing Test Installer"
  OutFile "Processing_Test_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Processing Test"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Processing Test.dll"
  ${Else}
  File "..\Bin\Win32\VST\Processing Test.dll"
  ...
  StrCpy $0 "$INSTDIR\Processing Test.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Processing_Test.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Processing Test VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Processing Test VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Processing Test.dll"
  Delete "$INSTDIR\Processing Test.pdf"

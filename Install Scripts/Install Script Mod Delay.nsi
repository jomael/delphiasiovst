...
;General
  ...
  ;Name and file
  Name "Mod Delay Installer"
  OutFile "Mod_Delay_Install.exe"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Mod Delay.dll"
  ${Else}
  File "..\Bin\Win32\VST\Mod Delay.dll"
  ...
  StrCpy $0 "$INSTDIR\Mod Delay.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Mod_Delay.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Mod Delay VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Mod Delay VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Mod Delay.dll"
  Delete "$INSTDIR\Mod Delay.pdf"

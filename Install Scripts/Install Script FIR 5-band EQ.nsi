...
;General
  ...
  ;Name and file
  Name "FIR 5-band EQ Installer"
  OutFile "FIR_5-band_EQ_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "FIR 5-band EQ"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\FIR 5-band EQ.dll"
  ${Else}
  File "..\Bin\Win32\VST\FIR 5-band EQ.dll"
  ...
  StrCpy $0 "$INSTDIR\FIR 5-band EQ.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_FIR_5-band_EQ.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "FIR 5-band EQ VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "FIR 5-band EQ VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\FIR 5-band EQ.dll"
  Delete "$INSTDIR\FIR 5-band EQ.pdf"

...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Gate.dll"
  ${Else}
  File "..\Bin\Win32\VST\Gate.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Gate.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Gate VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Gate VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Gate.dll"
  Delete "$INSTDIR\Gate.pdf"

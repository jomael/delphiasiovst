...
;General
  ...
  OutFile "Graphic_EQ_Install.exe"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Graphic EQ.dll"
  ${Else}
  File "..\Bin\Win32\VST\Graphic EQ.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Graphic_EQ.exe"
SectionEnd

...
;General
  ...
  ;Name and file
  Name "Baxxpander Clone Installer"
  OutFile "Baxxpander_Clone_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Baxxpander Clone"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Baxxpander Clone.dll"
  ${Else}
  File "..\Bin\Win32\VST\Baxxpander Clone.dll"
  ...
  StrCpy $0 "$INSTDIR\Baxxpander Clone.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Baxxpander_Clone.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Baxxpander Clone VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Baxxpander Clone VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Baxxpander Clone.dll"
  Delete "$INSTDIR\Baxxpander Clone.pdf"

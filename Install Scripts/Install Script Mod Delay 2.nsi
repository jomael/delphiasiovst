...
;General
  ...
  ;Name and file
  Name "Mod Delay 2 Installer"
  OutFile "Mod_Delay_2_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Mod Delay 2"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Mod Delay 2.dll"
  ${Else}
  File "..\Bin\Win32\VST\Mod Delay 2.dll"
  ...
  StrCpy $0 "$INSTDIR\Mod Delay 2.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Mod_Delay_2.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Mod Delay 2 VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Mod Delay 2 VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Mod Delay 2.dll"
  Delete "$INSTDIR\Mod Delay 2.pdf"

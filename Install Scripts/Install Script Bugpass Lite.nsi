...
;General
  ...
  ;Name and file
  Name "Bugpass Lite Installer"
  OutFile "Bugpass_Lite_Install.exe"
...
Section "VST-Plugin" SecVstPlugin
  ...
  StrCpy $0 "$INSTDIR\Bugpass Lite.dll" 

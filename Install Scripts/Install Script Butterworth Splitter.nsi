...
;Butterworth Splitter Installer
...
;General
  ...
  ;Name and file
  Name "Butterworth Splitter Installer"
  OutFile "Butterworth_Splitter_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Butterworth Splitter"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Butterworth Splitter.dll"
  ${Else}
  File "..\Bin\Win32\VST\Butterworth Splitter.dll"
  ...
  StrCpy $0 "$INSTDIR\Butterworth Splitter.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Butterworth_Splitter.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Butterworth Splitter VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Butterworth Splitter VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Butterworth Splitter.dll"
  Delete "$INSTDIR\Butterworth Splitter.pdf"

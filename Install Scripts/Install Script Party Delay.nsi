...
;General
  ...
  ;Name and file
  Name "Party Delay Installer"
  OutFile "Party_Delay_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Party Delay"
...
Section "Party Delay VST-Plugin" SecVstPlugin
  SetOutPath "$INSTDIR"
  
  !system 'copy "..\Bin\PartyDelay.dll" "..\Bin\Party Delay.dll"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Party Delay.dll"
  ...
  StrCpy $0 "$INSTDIR\Party Delay.dll" 
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Party_Delay.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Party Delay VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Party Delay VST Plugin"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Party Delay.dll"

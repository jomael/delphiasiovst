...
;General
  ...
  ;Name and file
  Name "Linkwitz Riley LFE Installer"
  OutFile "Linkwitz_Riley_LFE_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Linkwitz Riley LFE"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Linkwitz Riley LFE.dll"
  ${Else}
  File "..\Bin\Win32\VST\Linkwitz Riley LFE.dll"
  ...
  StrCpy $0 "$INSTDIR\Linkwitz Riley LFE.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Linkwitz_Riley_LFE.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Linkwitz Riley LFE VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Linkwitz Riley LFE VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Linkwitz Riley LFE.dll"
  Delete "$INSTDIR\Linkwitz Riley LFE.pdf"

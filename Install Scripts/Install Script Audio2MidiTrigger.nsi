...
;General
  ...
  ;Name and file
  Name "Audio2MidiTrigger Installer"
  OutFile "Audio2MidiTrigger_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Audio2MidiTrigger"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Audio2MidiTrigger.dll"
  ${Else}
  File "..\Bin\Win32\VST\Audio2MidiTrigger.dll"
  ...
  StrCpy $0 "$INSTDIR\Audio2MidiTrigger.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Audio2MidiTrigger.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Audio2MidiTrigger VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Audio2MidiTrigger VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Audio2MidiTrigger.dll"
  Delete "$INSTDIR\Audio2MidiTrigger.pdf"

...
;General
  ...
  ;Name and file
  Name "Simple Vibrato Installer"
  OutFile "Simple_Vibrato_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Simple Vibrato"
...
Section "Simple Vibrato VST-Plugin" SecVstPlugin
  SetOutPath "$INSTDIR"
  
  !system 'copy "..\Bin\SimpleVibrato.dll" "..\Bin\Simple Vibrato.dll"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Simple Vibrato.dll"
  ...
  StrCpy $0 "$INSTDIR\Simple Vibrato.dll" 
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Simple Vibrato VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Simple Vibrato VST Plugin"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Simple Vibrato.dll"

...
;General
  ...
  ;Name and file
  Name "Linear Phase LinkwitzRiley Installer"
  OutFile "Linear_Phase_LinkwitzRiley_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Linear Phase LinkwitzRiley"
...
Section "VST-Plugin" SecVstPlugin
  ...
  !system 'copy "..\Bin\LinearPhaseLinkwitzRileyLP.dll" "..\Bin\Linear Phase LinkwitzRiley LP.dll"'  
  !system 'copy "..\Bin\LinearPhaseLinkwitzRileyHP.dll" "..\Bin\Linear Phase LinkwitzRiley HP.dll"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Linear Phase LinkwitzRiley LP.dll"
  File "..\Bin\Linear Phase LinkwitzRiley HP.dll"
  ...
  StrCpy $0 "$INSTDIR\Linear Phase LinkwitzRiley LP.dll" 
  System::Call 'madExcept Patch::PatchMadExceptDLL(t) i (r0).r1'
  StrCpy $0 "$INSTDIR\Linear Phase LinkwitzRiley HP.dll" 
  System::Call 'madExcept Patch::PatchMadExceptDLL(t) i (r0).r1'
  System::Free 0
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Linear_Phase_LinkwitzRiley.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Linear Phase LinkwitzRiley VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Linear Phase LinkwitzRiley VST Plugin"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Linear Phase LinkwitzRiley LP.dll"
  Delete "$INSTDIR\Linear Phase LinkwitzRiley HP.dll"

...
;Linear Phase LinkwitzRiley LP Installer
...
;General
  ...
  ;Name and file
  Name "Linear Phase LinkwitzRiley LP Installer"
  OutFile "Linear_Phase_LinkwitzRiley_LP_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Linear Phase LinkwitzRiley LP"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Linear Phase LinkwitzRiley LP.dll"
  ${Else}
  File "..\Bin\Win32\VST\Linear Phase LinkwitzRiley LP.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Linear_Phase_LinkwitzRiley_LP.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Linear Phase LinkwitzRiley LP VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Linear Phase LinkwitzRiley LP VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Linear Phase LinkwitzRiley LP.pdf"

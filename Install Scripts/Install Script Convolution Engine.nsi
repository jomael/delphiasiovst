...
;General
  ...
  ;Name and file
  Name "Convolution Engine Installer"
  OutFile "Convolution_Engine_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Convolution Engine"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Convolution Engine.dll"
  ${Else}
  File "..\Bin\Win32\VST\Convolution Engine.dll"
  ...
  StrCpy $0 "$INSTDIR\Convolution Engine.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Convolution_Engine.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Convolution Engine VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Convolution Engine VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Convolution Engine.dll"
  Delete "$INSTDIR\Convolution Engine.pdf"

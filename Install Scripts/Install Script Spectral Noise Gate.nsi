...
;General
  ...
  ;Name and file
  Name "Spectral Noise Gate Installer"
  OutFile "Spectral_Noise_Gate_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Spectral Noise Gate"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Spectral Noise Gate.dll"
  ${Else}
  File "..\Bin\Win32\VST\Spectral Noise Gate.dll"
  ...
  StrCpy $0 "$INSTDIR\Spectral Noise Gate.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Spectral_Noise_Gate.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Spectral Noise Gate VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Spectral Noise Gate VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Spectral Noise Gate.dll"
  Delete "$INSTDIR\Spectral Noise Gate.pdf"

...
;General
  ...
  ;Name and file
  Name "Butterworth LP Installer"
  OutFile "Butterworth_LP_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Butterworth LP"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Butterworth LP.dll"
  ${Else}
  File "..\Bin\Win32\VST\Butterworth LP.dll"
  ...
  StrCpy $0 "$INSTDIR\Butterworth LP.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Butterworth_LP.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Butterworth LP VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Butterworth LP VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Butterworth LP.dll"
  Delete "$INSTDIR\Butterworth LP.pdf"

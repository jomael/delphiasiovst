...
;General
  ...
  ;Name and file
  Name "Chebyshev Type1 LP Installer"
  OutFile "Chebyshev_Type1_LP_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Chebyshev Type1 LP"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Chebyshev Type1 LP.dll"
  ${Else}
  File "..\Bin\Win32\VST\Chebyshev Type1 LP.dll"
  ...
  StrCpy $0 "$INSTDIR\Chebyshev Type1 LP.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Chebyshev_Type1_LP.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Chebyshev Type1 LP VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Chebyshev Type1 LP VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Chebyshev Type1 LP.dll"
  Delete "$INSTDIR\Chebyshev Type1 LP.pdf"

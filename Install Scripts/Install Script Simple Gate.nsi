...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Simple Gate.dll"
  ${Else}
  File "..\Bin\Win32\VST\Simple Gate.dll"
  ...
  StrCpy $0 "$INSTDIR\Simple Gate.dll"
...
;Descriptions
  ...
  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Simple Gate VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Simple Gate.pdf"

...
;General
  ...
  ;Name and file
  Name "Phase Adjustment Installer"
  OutFile "Phase_Adjustment_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Phase Adjustment"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Phase Adjustment.dll"
  ${Else}
  File "..\Bin\Win32\VST\Phase Adjustment.dll"
  ...
  StrCpy $0 "$INSTDIR\Phase Adjustment.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Phase_Adjustment.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Phase Adjustment VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Phase Adjustment VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Phase Adjustment.dll"
  Delete "$INSTDIR\Phase Adjustment.pdf"

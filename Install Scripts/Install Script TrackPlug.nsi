...
;General
  ...
  ;Name and file
  Name "TrackPlug Installer"
  OutFile "TrackPlug_Install.exe"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\TrackPlug.dll"
  ${Else}
  File "..\Bin\Win32\VST\TrackPlug.dll"
  ...
  StrCpy $0 "$INSTDIR\TrackPlug.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_TrackPlug.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "TrackPlug VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "TrackPlug VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\TrackPlug.dll"
  Delete "$INSTDIR\TrackPlug.pdf"

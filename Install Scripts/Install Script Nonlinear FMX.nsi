...
;General
  ...
  ;Name and file
  Name "Nonlinear FMX Installer"
  OutFile "Nonlinear_FMX_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Nonlinear FMX"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Nonlinear FMX.dll"
  ${Else}
  File "..\Bin\Win32\VST\Nonlinear FMX.dll"
  ...
  StrCpy $0 "$INSTDIR\Nonlinear FMX.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Nonlinear_FMX.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Nonlinear FMX VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Nonlinear FMX VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Nonlinear FMX.dll"
  Delete "$INSTDIR\Nonlinear FMX.pdf"

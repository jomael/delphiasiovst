...
;General
  ...
  ;Name and file
  Name "Load VST Plugin Installer"
  OutFile "Load_VST_Plugin_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Load VST Plugin"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Load VST Plugin.dll"
  ${Else}
  File "..\Bin\Win32\VST\Load VST Plugin.dll"
  ...
  StrCpy $0 "$INSTDIR\Load VST Plugin.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Load_VST_Plugin.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Load VST Plugin VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Load VST Plugin VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Load VST Plugin.dll"
  Delete "$INSTDIR\Load VST Plugin.pdf"

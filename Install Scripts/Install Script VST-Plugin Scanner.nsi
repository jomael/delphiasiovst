...
;General
  ...
  ;Name and file
  Name "VST-Plugin Scanner Installer"
  OutFile "VST_Plugin_Scanner_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "VST-Plugin Scanner"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\VST-Plugin Scanner.exe"

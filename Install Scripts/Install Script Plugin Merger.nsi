...
;General
  ...
  ;Name and file
  Name "Plugin Merger Installer"
  OutFile "Plugin_Merger_Install.exe"

  ;Default installation folder
  InstallDir "$PROGRAMFILES\Plugin Merger"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Plugin Merger"
...
Section "Program Files" SecProgramFiles
  ...
  !system 'copy "..\Bin\PluginMerger.exe" "..\Bin\Plugin Merger.exe"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Plugin Merger.exe"
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Plugin Merger Program Files"

  LangString DESC_SecProgramFiles ${LANG_ENGLISH} "Plugin Merger Program Files"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Plugin Merger.exe"

...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Phaser.dll"
  ${Else}
  File "..\Bin\Win32\VST\Phaser.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Phaser.exe"
SectionEnd
...
;Descriptions
  ...
  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Phaser VST Plugin"

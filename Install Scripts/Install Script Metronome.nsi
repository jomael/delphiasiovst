...
;General
  ...
  ;Name and file
  Name "Metronome Installer"
  OutFile "Metronome_Install.exe"
...
Section "ASIO Metronome" SecProgramFiles
  SetOutPath "$INSTDIR"
  
  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Metronome.exe"

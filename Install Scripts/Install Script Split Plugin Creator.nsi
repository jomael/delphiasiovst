...
;Split Plugin Creator Installer
...
;General
  ...
  ;Name and file
  Name "Split Plugin Creator Installer"
  OutFile "Split_Plugin_Creator_Install.exe"

  ;Default installation folder
  InstallDir "$PROGRAMFILES\Split Plugin Creator"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Split Plugin Creator"
...
Section "Program Files" SecProgramFiles
  ...
  !system 'copy "..\Bin\SplitPluginCreator.exe" "..\Bin\Split Plugin Creator.exe"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Split Plugin Creator.exe"

  ;Store installation folder
  WriteRegStr HKLM "SOFTWARE\Delphi ASIO & VST Packages\${PRODUCT_NAME}" "" $INSTDIR
  
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Split_Plugin_Creator.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Split Plugin Creator Program Files"

  LangString DESC_SecProgramFiles ${LANG_ENGLISH} "Split Plugin Creator Program Files"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Split Plugin Creator.exe"

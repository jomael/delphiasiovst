...
;General
  ...
  ;Name and file
  Name "Soft Knee Limiter Installer"
  OutFile "Soft_Knee_Limiter_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Soft Knee Limiter"
...
Section "VST-Plugin" SecVstPlugin
  ...
  ${If} ${RunningX64}
  File "..\Bin\Win64\VST\Soft Knee Limiter.dll"
  ${Else}
  File "..\Bin\Win32\VST\Soft Knee Limiter.dll"
  ...
  StrCpy $0 "$INSTDIR\Soft Knee Limiter.dll"
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Soft_Knee_Limiter.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Soft Knee Limiter VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Soft Knee Limiter VST Plugin"
...
Section "Uninstall"
  ...
  Delete "$INSTDIR\Soft Knee Limiter.dll"
  Delete "$INSTDIR\Soft Knee Limiter.pdf"

...
;General
  ...
  ;Name and file
  Name "Simple Compressor Installer"
  OutFile "Simple_Compressor_Install.exe"
...
;Interface Settings
  ...
  !define PRODUCT_NAME "Simple Compressor"
...
Section "Simple Compressor VST-Plugin" SecVstPlugin
  SetOutPath "$INSTDIR"
  
  !system 'copy "..\Bin\SimpleCompressor.dll" "..\Bin\Simple Compressor.dll"'  

  ;ADD YOUR OWN FILES HERE...
  File "..\Bin\Simple Compressor.dll"
  ...
  StrCpy $0 "$INSTDIR\Simple Compressor.dll" 
...
SkipDLLCall:
  ...
  ;Create uninstaller
  WriteUninstaller "$INSTDIR\Uninstall_Simple_Compressor.exe"
SectionEnd
...
;Descriptions
  ...
  LangString TEXT_IO_SUBTITLE ${LANG_ENGLISH} "Simple Compressor VST Plugin"

  LangString DESC_SecVstPlugin ${LANG_ENGLISH} "Simple Compressor VST Plugin"
...
Section "Uninstall"
  ...
  ;ADD YOUR OWN FILES HERE...
  Delete "$INSTDIR\Simple Compressor.dll"

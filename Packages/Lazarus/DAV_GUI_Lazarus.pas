...
uses
  ...
  DAV_GuiAudioDataDisplayCursor, DAV_GuiBitmap, DAV_GuiBitmapText, 
  DAV_GuiBlend, DAV_GuiBlendReference, DAV_GuiByteMap, DAV_GuiCommon, 
  DAV_GuiCustomMap, DAV_GuiDesign, DAV_GuiDial, DAV_GuiDialDesign, 
  DAV_GuiDialRenderer, DAV_GuiEQGraph, DAV_GuiEQSlide, 
  DAV_GuiFileFormatGraphics, DAV_GuiFileFormats, DAV_GuiFilters, 
  DAV_GuiFixedPoint, DAV_GuiFont, DAV_GuiFontList, DAV_GuiGraphXY, 
  DAV_GuiGraphXYDesign, DAV_GuiInscription, DAV_GuiLED, DAV_GuiLevelMeter, 
  DAV_GuiMediaButton, DAV_GuiPaintBox, DAV_GuiPixelMap, DAV_GuiPixelMapDesign, 
  DAV_GuiShadow, DAV_GuiSlider, DAV_GuiStitchedButton, 

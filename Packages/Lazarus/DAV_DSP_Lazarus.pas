...
uses
    ...
    DAV_DspCorrelation, DAV_DspCrosstalkCancellation, 
    DAV_DspCrosstalkSimulator, DAV_DspDFT, DAV_DspDitherNoiseShaper, 
    DAV_DspDownsampleScheduler, DAV_DspDynamics, DAV_DspFDNReverb, 
    ...
    DAV_DspFilterSimple, DAV_DspFilterSpectralDelay, DAV_DspFreeverb, 
    DAV_DspFreeverbFilter, DAV_DspFrequencyDivider, DAV_DspInterpolation, 
    DAV_DspLevelingAmplifier, DAV_DspLFO, DAV_DspLightweightDynamics, 
    DAV_DspMetronome, DAV_DspMinBlep, DAV_DspPhaser, DAV_DspPlateReverb, 
    ...
    DAV_DspWindowing, DAV_DspR128, LazarusPackageIntf;
